...
<div class="flex-cell pad--1">
    <h1>Cols center</h1>
    <div class="container cols--center mar--1" style="min-height: 100px;">
        <div class="cell--s pad--4 cell--self-start">1</div>
        <div class="cell--s pad--6">1-2</div>
        <div class="cell--s pad--4">1</div>
        <div class="cell--s pad--4">1</div>
    </div>
</div>
...
<div class="flex-cell--static pad-1">
    ...
    <main style="height: 300px; width: 600px" class="flex-columns flex-multi flex-cell">
