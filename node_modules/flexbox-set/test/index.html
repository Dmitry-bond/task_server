...
<body class="flex-rows flex--cross-start">

<div class="flex-cell--static pad-1">
...
<main style="height: 600px; width: 600px"
    class="flex-columns flex-multi flex-multi--cross-between flex--cross-end">

    <div class="flex-cell--static">STATIC</div>
    <div class="flex-cell--pull-right">1</div>
    <div class="flex-cell--pull-left">2</div>
    <div class="flex-cell--static">3</div>
    <div class="flex-cell--pull-right">STATIC RIGHT</div>
    ...
    <div class="flex-cell--2-3">2/3</div>
    <div class="flex-cell--1-3 flex-rows" style="height: 200px;">
        <div class="flex-cell--1-3">1/3 1/3</div>
        <div class="flex-cell--2-3">1/3 2/3</div>
    </div>
</main>
-->
